...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Nyxcord settings section",
        options: [
...
export default definePlugin({
    ...
    getInfoRows() {
        ...
        const rows = [`Nyxcord ${gitHashShort}${getVersionInfo()}`];
