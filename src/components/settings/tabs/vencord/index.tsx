        ...
        <SettingsTab>
            {(isEquicordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    ...
                    description={
                        isEquicordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Nyxcord users can see your Nyxcord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Nyxcord donor badge, make a ticket in Nyxcord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Nyxcord users can see your badge! You can manage your perks by making a ticket in Nyxcord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Nyxcord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Nyxcord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Nyxcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(EquicordSettings, "Nyxcord Settings — v0.13.0");
